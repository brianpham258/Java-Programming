...
public class HoldThenUnhold {
	...
	public static void holdThenUnhold() {
		//load the sheet in which data is stored
    	...
    	else if(!condition.getText().equals("Reviewed")) {
    		if(isBlank()) {
    			System.exit(0);
    		}
    		row++;
    	...
    	if(sheet.getRow(row) != null) {
			...
			try {
				//Select Hold Claim
				driver.findElement(By.xpath("//*[@id=\"page-wrapper\"]/div/div[2]/div/div[1]/a[5]")).click();
				
				//Confirm Hold
				driver.findElement(By.cssSelector("button[type=\"submit\"]")).submit();
				
				//Select Un-Hold Claim
				driver.findElement(By.xpath("//*[@id=\"page-wrapper\"]/div/div[3]/div/div[1]/a[6]")).click();
				
				//Confirm Un-Hold Claim
				driver.findElement(By.cssSelector("button[type=\"submit\"]")).submit();
			}
